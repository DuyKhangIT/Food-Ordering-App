...
class _CartPageState extends State<CartPage> {
  ...
  Future<RemoveItemOrderResponse> removeItemOrderApi(
    ...
    try {
      body = await HttpHelper.invokeHttp(
          Uri.parse(
              "https://apibeflutterdlaw.up.railway.app/api/order/remove-item"),
          RequestType.post,
          headers: null,
  ...
  Future<SumOrderResponse> sumOrderApi(SumOrderRequest sumOrderRequest) async {
    ...
    try {
      body = await HttpHelper.invokeHttp(
          Uri.parse("https://apibeflutterdlaw.up.railway.app/api/order/sum"),
          RequestType.post,
          headers: null,
  ...
  Future<CheckoutOrderResponse> checkoutOrderApi(
    ...
    try {
      body = await HttpHelper.invokeHttp(
          Uri.parse(
              "https://apibeflutterdlaw.up.railway.app/api/order/checkout"),
          RequestType.post,
          headers: null,
          body: const JsonEncoder()
