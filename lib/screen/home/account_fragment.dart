...
import 'package:th_flutter/model/change_account/change_account_request.dart';
import 'package:th_flutter/model/change_account/change_account_response.dart';
  ...
  Future<ChangeAccountResponse> changeAccountApi(
    ...
    try {
      body = await HttpHelper.invokeHttp(
          Uri.parse(
              "https://apibeflutterdlaw.up.railway.app/api/user/update-user"),
          RequestType.put,
          headers: null,
              ...
              onTap: () {
                if (Global.isAvailableToClick()) {
                  if (username.isNotEmpty &&
                      ...
                      changeNewPassword.isNotEmpty && changeConfirmNewPassword.isNotEmpty) {
