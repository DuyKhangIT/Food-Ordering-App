...
import 'package:th_flutter/model/register/register_request.dart';
import 'package:th_flutter/model/register/register_response.dart';
import 'package:th_flutter/screen/sign_in/sign_in_page.dart';
import 'package:th_flutter/util/show_loading_dialog.dart';
  ...
  Future<RegisterResponse> registerApi(RegisterRequest registerRequest) async {
    ...
    try {
      body = await HttpHelper.invokeHttp(
          Uri.parse(
              "http://14.225.204.248:7070/api/user/register"),
          RequestType.post,
          headers: null,
